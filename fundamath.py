...
def get_funda_ratios(sym):
    ...
    r_frame.loc['acid-test_ratio'] = (frame.loc['totalCurrentAssets'] - frame.loc['inventory']) / frame.loc[
        'totalCurrentLiabilities']

    r_frame.loc['cash_ratio'] = frame.loc['cash'] / frame.loc['totalCurrentLiabilities']

    r_frame.loc['operating_cash_flow'] = frame.loc['totalCashFromOperatingActivities'] / frame.loc[
        'totalCurrentLiabilities']
